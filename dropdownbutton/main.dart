  ...
  Widget build(BuildContext context) {
    ...
    Padding (
        ...
        child: TextField(
            ...
            DropdownButton<String> (value:_selectedcity,items: cities.map((String slected ){
              return DropdownMenuItem<String>(child: Text(slected),value: slected);}).toList(),onChanged: (selected){setState(() {
