    ...
    return Column(mainAxisAlignment: MainAxisAlignment.center,
        children: <Widget>[
          ...
          Row(mainAxisAlignment: MainAxisAlignment.spaceAround,
              children: <Widget>[  ElevatedButton(onPressed: _play, child: Text("play")),
                ElevatedButton(onPressed: _pause, child: Text("pause")),
              ]),
          Consumer<VolumeManager>(builder:(context,volumemanager,_) {
            return Slider(value: volumemanager.volume,min: 0,max: 100,
              onChanged: (value) {
              volumemanager.set_volume(volume_value: value, controller: controller);
              },
